...
.DESCRIPTION
    ...
    GitHubCli.psd1. Run by the release workflow before publishing, and locally
...
.EXAMPLE
    ./build/Update-ReleaseArtifacts.ps1 -Version v0.11.0
#>
[CmdletBinding(SupportsShouldProcess)]
param(
    # The release version, with or without a leading 'v' (e.g. v0.11.0 or 0.11.0).
    [Parameter(Mandatory)]
    [string]
    $Version,
    ...
    [string]
    $ManifestPath = (Join-Path $PSScriptRoot '../src/GithubCli/GitHubCli.psd1'),
...
if ($NormalizedVersion -notmatch '^\d+\.\d+\.\d+$') {
    throw "Version '$Version' is not a three-part version (e.g. v0.11.0)."
}
