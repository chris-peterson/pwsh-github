...
title: New-GithubPullRequestComment
---
...
```
New-GithubPullRequestComment [-PullRequestId] <int> -Body <string> [-RepositoryId <string>]
...
Creates a new comment on the specified GitHub pull request.

## EXAMPLES

### Example 1

New-GithubPullRequestComment 42 -Body 'LGTM'
