...
title: Update-GithubPullRequest
---
...
```
Update-GithubPullRequest [-PullRequestId] <int> [-RepositoryId <string>] [-Title <string>]
 [-Description <string>] [-State <string>] [-TargetBranch <string>] [-Draft] [-MarkReady]
 [-MaintainerCanModify] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Updates properties of an existing pull request such as title, description, state, target branch, and draft status.

## EXAMPLES

### Example 1

Update-GithubPullRequest 42 -Title 'Updated title'
