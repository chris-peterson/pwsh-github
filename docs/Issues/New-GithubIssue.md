...
```
New-GithubIssue [[-RepositoryId] <string>] [-Title] <string> [[-Description] <string>]
 [[-Assignees] <string[]>] [[-Labels] <string[]>] [[-MilestoneNumber] <int>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Creates a new issue in a GitHub repository with the specified title and optional description, assignees, labels, and milestone.

## EXAMPLES

### Example 1

New-GithubIssue -Title 'Bug: login fails'
